...
INSERT INTO item (name, description, price, seller_id, quantity, category_id, reference) VALUES
    ("Toaster", "Warms bread and other bread items.", 60.11, 1, 3, 1, 1),
    ("Microwave", "Warms items that you put inside for any amount of time.", 45.23, 1, 11, 1, 2),
    ("Television", "70 inch 3D television, guaranteed to completely destroy your eyes.", 5000, 1, 1, 1, 3),
    ("Coca-Cola", "A delicious can of coke.", 2.99, 2, 100, 2, 4),
    ("Grapes", "A bundle of 5-8 grapes.", 5.66, 3, 57, 2, 5),
    ("Bananas", "A bundle of 6-7 bananas.", 3.33, 3, 24, 2, 6),
    ("Log", "A single log, used for making fires.", 23.66, 4, 5, 3, 7),
    ("Tent", "A tent to keep you and the whole family warm.", 15.66, 4, 11, 3, 8),
    ("Hammock", "A hammock to lay on.", 13.33, 4, 17, 3, 9),
    ("Battlefront 2", "The horrible EA remake.", 2.22, 1, 1000, 4, 10),
    ("Chutes and Ladders", "A game of wit and deception.", 13.22, 1, 33, 4, 11),
    ("Overwatch", "The cult-classic.", 40, 1, 14, 4, 12),
    ("War and Peace", "A classic long-winded novel.", 15, 2, 5, 5, 13),
    ("Green Eggs and Ham", "The classic Dr. Seuss story.", 15, 2, 5, 5, 14),
    ("A Game of Thrones", "The first book in George R.R. Martin's fantasy series.", 15, 2, 5, 5, 15),
    ("Hat", "A hat.", 16, 3, 15, 6, 16),
    ("Shorts", "A pair of okay shorts.", 23.15, 3, 25, 6, 17),
    ("Shirt", "A lousy ole' shirt.", 19.27, 3, 11, 6, 18);
